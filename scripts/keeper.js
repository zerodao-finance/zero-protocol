...
const { DelegateUnderwriterTransferRequest } = require('../lib/zero');
const { createZeroConnection, createZeroKeeper } = require('../lib/zero');
const DelegateUnderwriter = require('../deployments/arbitrum/DelegateUnderwriter');
const delegate = new ethers.Contract(DelegateUnderwriter.address, DelegateUnderwriter.abi, new ethers.providers.InfuraProvider('mainnet'));
