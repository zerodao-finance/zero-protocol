...
const DelegateUnderwriterJson = require("../../../deployments/matic/DelegateUnderwriter.json");
...
export const DelegateUnderwriter = new Contract(DelegateUnderwriterJson.address, DelegateUnderwriterJson.abi, signer);
...
export const ZeroUnderwriterImpl = new Contract(DelegateUnderwriterJson.address, ZeroControllerJson.abi, signer);