...
export class DelegateUnderwriterTransferRequest extends TransferRequest {
	async getController(signer) {
		const underwriter = this.getDelegateUnderwriter(signer);
