...
contract sOlympus is ERC20Permit, Ownable {
  ...
  constructor() ERC20("Staked Olympus", "sZERO", 9) ERC20Permit() {
  ...
  /**
        @notice increases sZERO supply to increase staking balances relative to profit_
  ...
  // Staking contract holds excess sZERO
