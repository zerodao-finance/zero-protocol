...
contract BadgerBridgeZeroControllerFantom is EIP712Upgradeable {
  ...
  address constant factory = 0x152ee697f2e276fa89e96742e9bb9ab1f2e61be3;
  address constant router = 0xF491e7B69E4244ad4002BC14e878a34207E38c29;
  ...
  address constant renCrv = 0x3eF6A01A0f81D6046290f3e2A8c5b843e738E604;
  address constant tricrypto = 0x3a1659Ddcf2339Be3aeA159cA010979FB49155FF; 
  address constant renCrvLp = 0x5B5CFE992AdAC0C9D48E05854B2d91C73a003858; 
  ...
  function initialize(address _governance, address _strategist) public initializer {
    ...
    IERC20(usdc).safeApprove(usdc, ~uint256(0) >> 2);
