					...
					or(
						...
						or(
							...
							or(
								...
								or(gt(btcFeeForRepayGas, MaxUint24), gt(lastUpdateTimestamp, MaxUint32))
							)
						)
					)
				)
...
//////////////////////////////////////////////////////////////*/
	...
	function setRepayParams(
		...
		assembly {
			if or(gt(ethRefundForRepayGas, MaxUint64), gt(btcFeeForRepayGas, MaxUint24)) {
				mstore(0, Panic_error_signature)
				mstore(Panic_error_offset, Panic_arithmetic)
				revert(0, Panic_error_length)
			}
	...
	function setCached(
		...
		assembly {
			if or(
				...
				or(
					gt(ethRefundForRepayGas, MaxUint64),
					or(gt(btcFeeForLoanGas, MaxUint24), or(gt(btcFeeForRepayGas, MaxUint24), gt(lastUpdateTimestamp, MaxUint32)))
				)
			) {
				mstore(0, Panic_error_signature)
				mstore(Panic_error_offset, Panic_arithmetic)
...
//////////////////////////////////////////////////////////////*/
	...
	function setLoanGasE4(ModuleState old, uint256 loanGasE4) internal pure returns (ModuleState updated) {
		assembly {
...
//////////////////////////////////////////////////////////////*/
	...
	function setRepayGasE4(ModuleState old, uint256 repayGasE4) internal pure returns (ModuleState updated) {
		assembly {
...
//////////////////////////////////////////////////////////////*/
	...
	function setEthRefundForRepayGas(ModuleState old, uint256 ethRefundForRepayGas)
		internal
		pure
		returns (ModuleState updated)
	{
...
//////////////////////////////////////////////////////////////*/
	...
	function setBtcFeeForLoanGas(ModuleState old, uint256 btcFeeForLoanGas) internal pure returns (ModuleState updated) {
		assembly {
