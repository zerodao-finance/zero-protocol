...
//////////////////////////////////////////////////////////////*/
    ...
    )
  {
    assembly {
      ...
      renBorrowFeeBips := and(MaxUint11, shr(GlobalState_renBorrowFeeBips_bitsAfter, encoded))
      zeroFeeShareBips := and(MaxUint13, shr(GlobalState_zeroFeeShareBips_bitsAfter, encoded))
      zeroBorrowFeeStatic := and(MaxUint23, shr(GlobalState_zeroBorrowFeeStatic_bitsAfter, encoded))
      renBorrowFeeStatic := and(MaxUint23, shr(GlobalState_renBorrowFeeStatic_bitsAfter, encoded))
      totalBitcoinBorrowed := and(MaxUint48, shr(GlobalState_totalBitcoinBorrowed_bitsAfter, encoded))
      satoshiPerEth := and(MaxUint40, shr(GlobalState_satoshiPerEth_bitsAfter, encoded))
      gweiPerGas := and(MaxUint16, shr(GlobalState_gweiPerGas_bitsAfter, encoded))
      lastUpdateTimestamp := and(MaxUint32, shr(GlobalState_lastUpdateTimestamp_bitsAfter, encoded))
    }
  }
    ...
    assembly {
      if or(
        ...
        or(
          ...
          or(
            gt(totalBitcoinBorrowed, MaxUint48),
...
//////////////////////////////////////////////////////////////*/
  ...
  function setLoanInfo(GlobalState old, uint256 totalBitcoinBorrowed) internal pure returns (GlobalState updated) {
    assembly {
      if gt(totalBitcoinBorrowed, MaxUint48) {
        mstore(0, Panic_error_signature)
        mstore(Panic_error_offset, Panic_arithmetic)
        revert(0, Panic_error_length)
      }
  ...
  function getLoanInfo(GlobalState encoded) internal pure returns (uint256 totalBitcoinBorrowed) {
    assembly {
      totalBitcoinBorrowed := and(MaxUint48, shr(GlobalState_totalBitcoinBorrowed_bitsAfter, encoded))
    }
  }
...
//////////////////////////////////////////////////////////////*/
  ...
  function setFees(
    ...
    assembly {
      if or(gt(zeroBorrowFeeStatic, MaxUint23), gt(renBorrowFeeStatic, MaxUint23)) {
        mstore(0, Panic_error_signature)
        mstore(Panic_error_offset, Panic_arithmetic)
        revert(0, Panic_error_length)
      }
...
//////////////////////////////////////////////////////////////*/
  ...
  function setParamsForModuleFees(
    ...
    assembly {
      if or(gt(satoshiPerEth, MaxUint40), gt(gweiPerGas, MaxUint16)) {
        mstore(0, Panic_error_signature)
        mstore(Panic_error_offset, Panic_arithmetic)
        revert(0, Panic_error_length)
      }
...
//////////////////////////////////////////////////////////////*/
  ...
  function getZeroBorrowFeeBips(GlobalState encoded) internal pure returns (uint256 zeroBorrowFeeBips) {
    assembly {
      zeroBorrowFeeBips := shr(GlobalState_zeroBorrowFeeBips_bitsAfter, encoded)
    }
  }
...
//////////////////////////////////////////////////////////////*/
  ...
  function getRenBorrowFeeBips(GlobalState encoded) internal pure returns (uint256 renBorrowFeeBips) {
    assembly {
      renBorrowFeeBips := and(MaxUint11, shr(GlobalState_renBorrowFeeBips_bitsAfter, encoded))
    }
  }

  function setRenBorrowFeeBips(GlobalState old, uint256 renBorrowFeeBips) internal pure returns (GlobalState updated) {
    assembly {
      updated := or(
...
//////////////////////////////////////////////////////////////*/
  ...
  function getZeroFeeShareBips(GlobalState encoded) internal pure returns (uint256 zeroFeeShareBips) {
    assembly {
      zeroFeeShareBips := and(MaxUint13, shr(GlobalState_zeroFeeShareBips_bitsAfter, encoded))
    }
  }

  function setZeroFeeShareBips(GlobalState old, uint256 zeroFeeShareBips) internal pure returns (GlobalState updated) {
    assembly {
      updated := or(
...
//////////////////////////////////////////////////////////////*/
  ...
  function getZeroBorrowFeeStatic(GlobalState encoded) internal pure returns (uint256 zeroBorrowFeeStatic) {
    assembly {
      zeroBorrowFeeStatic := and(MaxUint23, shr(GlobalState_zeroBorrowFeeStatic_bitsAfter, encoded))
    }
  }
...
//////////////////////////////////////////////////////////////*/
  ...
  function getRenBorrowFeeStatic(GlobalState encoded) internal pure returns (uint256 renBorrowFeeStatic) {
    assembly {
      renBorrowFeeStatic := and(MaxUint23, shr(GlobalState_renBorrowFeeStatic_bitsAfter, encoded))
    }
  }
...
//////////////////////////////////////////////////////////////*/
  ...
  function getTotalBitcoinBorrowed(GlobalState encoded) internal pure returns (uint256 totalBitcoinBorrowed) {
    assembly {
      totalBitcoinBorrowed := and(MaxUint48, shr(GlobalState_totalBitcoinBorrowed_bitsAfter, encoded))
    }
  }

  function setTotalBitcoinBorrowed(GlobalState old, uint256 totalBitcoinBorrowed)
    internal
    pure
    returns (GlobalState updated)
  {
...
//////////////////////////////////////////////////////////////*/
  ...
  function getSatoshiPerEth(GlobalState encoded) internal pure returns (uint256 satoshiPerEth) {
    assembly {
      satoshiPerEth := and(MaxUint40, shr(GlobalState_satoshiPerEth_bitsAfter, encoded))
    }
  }
...
//////////////////////////////////////////////////////////////*/
  ...
  function getGweiPerGas(GlobalState encoded) internal pure returns (uint256 gweiPerGas) {
    assembly {
      gweiPerGas := and(MaxUint16, shr(GlobalState_gweiPerGas_bitsAfter, encoded))
    }
  }
...
//////////////////////////////////////////////////////////////*/
  ...
  function getLastUpdateTimestamp(GlobalState encoded) internal pure returns (uint256 lastUpdateTimestamp) {
    assembly {
      lastUpdateTimestamp := and(MaxUint32, shr(GlobalState_lastUpdateTimestamp_bitsAfter, encoded))
    }
  }
...
//////////////////////////////////////////////////////////////*/
  ...
  function equals(GlobalState a, GlobalState b) internal pure returns (bool _equals) {
    assembly {
      _equals := eq(a, b)
    }
  }
