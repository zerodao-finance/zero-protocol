...
contract ExternalModuleStateCoder {
    ...
    )
  {
    (
      moduleType,
      ethRefundForLoanGas
    ) = ModuleStateCoder.getLoanParams(
      _moduleState
    );
  }
    ...
    )
  {
    (
      btcFeeForLoanGas,
      btcFeeForRepayGas
    ) = ModuleStateCoder.getBitcoinGasFees(
      _moduleState
    );
  }
    ...
    )
  {
    (
      ...
      ethRefundForRepayGas,
      btcFeeForRepayGas
    ) = ModuleStateCoder.getRepayParams(
      _moduleState
    );
  }
  ...
  {
    (loanGasE4, repayGasE4) = ModuleStateCoder
      .getGasParams(_moduleState);
  }
  ...
  {
    (moduleType) = ModuleStateCoder.getModuleType(
      _moduleState
    );
  }
  ...
  {
    (_moduleState) = ModuleStateCoder
      .setModuleType(_moduleState, moduleType);
  }

  function getLoanGasE4()
    external
    view
    returns (uint256 loanGasE4)
  {
    (loanGasE4) = ModuleStateCoder.getLoanGasE4(
      _moduleState
    );
  }

  function setLoanGasE4(uint256 loanGasE4)
    external
  {
    (_moduleState) = ModuleStateCoder
      .setLoanGasE4(_moduleState, loanGasE4);
  }

  function getRepayGasE4()
    external
    view
    returns (uint256 repayGasE4)
  {
    (repayGasE4) = ModuleStateCoder.getRepayGasE4(
      _moduleState
    );
  }

  function setRepayGasE4(uint256 repayGasE4)
    external
  {
    (_moduleState) = ModuleStateCoder
      .setRepayGasE4(_moduleState, repayGasE4);
  }
  ...
  {
    (ethRefundForLoanGas) = ModuleStateCoder
      .getEthRefundForLoanGas(_moduleState);
  }
  ...
  {
    (ethRefundForRepayGas) = ModuleStateCoder
      .getEthRefundForRepayGas(_moduleState);
  }
  ...
  {
    (btcFeeForLoanGas) = ModuleStateCoder
      .getBtcFeeForLoanGas(_moduleState);
  }
  ...
  {
    (btcFeeForRepayGas) = ModuleStateCoder
      .getBtcFeeForRepayGas(_moduleState);
  }
  ...
  {
    (lastUpdateTimestamp) = ModuleStateCoder
      .getLastUpdateTimestamp(_moduleState);
  }
