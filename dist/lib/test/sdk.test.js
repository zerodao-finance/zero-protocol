...
describe('computeP unit test', function () {
    it('has a correct return for computeP', function () {
        ...
        var pReturn = (0, helpers_1.computeP)('0x00', '1', ethers_1.constants.AddressZero, '0x00');
    ...
    it("doesn't modify a ghash passed through", function () {
        var expected = '0x1802dfcb2df77afef24f20ce516bd6ec50cec35aa1ed6359a81fd6d950006902';
        var gHash = (0, helpers_1.maybeCoerceToGHash)(expected);
        (0, chai_1.expect)(gHash).to.be.eq(expected);
    });
    it('creates a correct NHash', function () {
        var nHash = (0, helpers_1.computeNHash)({
            nonce: ethers_1.utils.formatBytes32String('1'),
    ...
    it('creates a correct TransferRequest', function () {
        var transferRequest = new zero_1.TransferRequest({
    ...
    it('creates a valid gateway address', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    transferRequest = new zero_1.TransferRequest({
                        asset: ethers_1.constants.AddressZero,
                        module: ethers_1.constants.AddressZero,
                        to: ethers_1.constants.AddressZero,
                        underwriter: ethers_1.constants.AddressZero,
                ...
                case 1:
                    ...
                    isValidAddress = (0, bitcoin_address_validation_1.validate)(gatewayAddress);
    ...
    it('creates a valid EIP721 response', function () {
        ...
        var EIP712 = transferRequest.toEIP712(ethers_1.constants.AddressZero, 1);
