...
let keeperSigner;
const createMockKeeper = (provider) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    keeper.setTxDispatcher = (fn) => __awaiter(void 0, void 0, void 0, function* () {
        keeper._txDispatcher = fn;
    });
    keeper.setTxDispatcher((transferRequest) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield new Promise((resolve, reject) => mint.on('deposit', (deposit) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            confirmed
                ...
                .on('deposit', (confs, target) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        trivial.waitForSignature = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            setTimeout(() => {
                (() => __awaiter(this, void 0, void 0, function* () {
                    try {
                        Promise.all(keepers.map((v) => __awaiter(this, void 0, void 0, function* () { return v._txDispatcher && v._txDispatcher(transferRequest); }))).catch(console.error);
                    }
                    catch (e) {
                        console.error(e);
                    }
