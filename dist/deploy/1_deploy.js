        ...
        return __generator(this, function (_p) {
            switch (_p.label) {
                ...
                case 22:
                    ...
                    if (!(hre.network.name === 'hardhat')) return [3 /*break*/, 23];
                    _g = deployer;
                    return [3 /*break*/, 25];
                ...
                case 24:
                    _g = (_p.sent()).address;
                    _p.label = 25;
                case 25: return [4 /*yield*/, _e.apply(void 0, _f.concat([(_o.args = [_g, zeroController.address, hre.network.name === 'hardhat' ? [deployer] : []],
                            _o.libraries = {},
                            _o.from = deployer,
                            _o)]))];
                case 26:
