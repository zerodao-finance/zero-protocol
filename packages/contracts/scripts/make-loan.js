...
const Underwriter = new Contract(underwriterAddress, underwriterAbi, wallet);
...
(async () => {
	const lock = await Controller.provider.getCode(await Controller.lockFor(Underwriter.address));
