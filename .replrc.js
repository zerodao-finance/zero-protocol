...
var provider = new ethers.providers.JsonRpcProvider(RPC_ENDPOINTS.ARBITRUM);
...
var ren = require('@renproject/ren');
var linker = require('solc/linker');

var signer = new ethers.providers.JsonRpcProvider('http://localhost:8545').getSigner();
